...

{
	...
	int lastStrPos = 0, lastMaxPos = 0;

	int lastMaxSize = 0;

	bool islastStrPosFree = false;
	//int islastStrPosFree;
...

	{
...

		{
...

			{
				...
				islastStrPosFree = true;

				if (i - lastStrPos > lastMaxSize)

				{

					lastMaxSize = i - lastStrPos;

					lastMaxPos = lastStrPos;
...

	{
...

		{
			...
			if (strSize - lastStrPos > lastMaxSize)

			{

				lastMaxSize = strSize - lastStrPos;
		...
		cout << "max string begin from pos: " << lastMaxPos << " and have size: " << lastMaxSize;
